...
TYPED_TEST_ALL_DEVICES(EltwiseLayerTest, TestProd,
  LayerParameter layer_param;
  EltwiseParameter* eltwise_param = layer_param.mutable_eltwise_param();
  eltwise_param->set_operation(EltwiseParameter_EltwiseOp_PROD);
  shared_ptr<EltwiseLayer<TypeParam> > layer(
...
TYPED_TEST_ALL_DEVICES(EltwiseLayerTest, TestSum,
  LayerParameter layer_param;
  EltwiseParameter* eltwise_param = layer_param.mutable_eltwise_param();
...
TYPED_TEST_ALL_DEVICES(EltwiseLayerTest, TestSumCoeff,
  LayerParameter layer_param;
  EltwiseParameter* eltwise_param = layer_param.mutable_eltwise_param();
  eltwise_param->set_operation(EltwiseParameter_EltwiseOp_SUM);
...
TYPED_TEST_ALL_DEVICES(EltwiseLayerTest, TestProdGradient,
  LayerParameter layer_param;
  EltwiseParameter* eltwise_param = layer_param.mutable_eltwise_param();
  eltwise_param->set_operation(EltwiseParameter_EltwiseOp_PROD);
...
TYPED_TEST_ALL_DEVICES(EltwiseLayerTest, TestSumGradient,
  LayerParameter layer_param;
  EltwiseParameter* eltwise_param = layer_param.mutable_eltwise_param();
  eltwise_param->set_operation(EltwiseParameter_EltwiseOp_SUM);
  EltwiseLayer<TypeParam> layer(layer_param);
...
TYPED_TEST_ALL_DEVICES(EltwiseLayerTest, TestSumCoeffGradient,
  LayerParameter layer_param;
  EltwiseParameter* eltwise_param = layer_param.mutable_eltwise_param();
  eltwise_param->set_operation(EltwiseParameter_EltwiseOp_SUM);
  eltwise_param->add_coeff(1);
