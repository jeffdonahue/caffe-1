...
TYPED_TEST_ALL_DEVICES(SplitLayerTest, Test,
  LayerParameter layer_param;
  SplitLayer<TypeParam> layer(layer_param);
  layer.SetUp(this->blob_bottom_vec_, &(this->blob_top_vec_));
...
TYPED_TEST_ALL_DEVICES(SplitLayerTest, TestInPlace,
  LayerParameter layer_param;
  SplitLayer<TypeParam> layer(layer_param);
...
TYPED_TEST_ALL_DEVICES(SplitLayerTest, TestGradient,
  LayerParameter layer_param;
  SplitLayer<TypeParam> layer(layer_param);
...
TYPED_TEST_ALL_DEVICES(SplitLayerTest, TestGradientInPlace,
  LayerParameter layer_param;
  SplitLayer<TypeParam> layer(layer_param);
  GradientChecker<TypeParam> checker(1e-2, 1e-2);
  this->blob_top_vec_[0] = this->blob_bottom_vec_[0];
